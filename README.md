...
# 工具类
优先从[hutool工具包](https://doc.hutool.cn/pages/index/)中找一找！
...
其实不用自己写啊！ hutool HttpUtil.downloadFile(String url, File destFile)
...
## JsonUtil
和JSON相关工具
### normalizeJsonEscapedMarkdown
解决大模型返回已转义的content，经过前端JSON.stringify又转义了一层；后端Jackson只会反转义一层，导致解码失败的问题。