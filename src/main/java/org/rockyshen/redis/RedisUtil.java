...
/**
 * 基于RedisTemplate封装了操作redis各种数据结构的方法，增加了异常处理
 */
...
public final class RedisUtil {
    ...
    /**
     * 如果已经存在，放不进去return fasle；之前不存在的，才能放进去 return true
     * @param key   键
     * @param value 值
     * @return true成功 false失败
     */
    ...
    /**
     * 获取hashKey对应一个key的所有field-value对，一行数据
     * @param key 键
     * @return 对应的多个键值
     */
    ...
    /**
     * HashSet
     * 获取hashKey所有key的所有field-value对，一张表
     * @param key 键
     * @param map 对应多个键值
    ...
    /**
     * 随机移除一个元素
     * @param key --> prize_coupon_prizeId
     * @return
     */
